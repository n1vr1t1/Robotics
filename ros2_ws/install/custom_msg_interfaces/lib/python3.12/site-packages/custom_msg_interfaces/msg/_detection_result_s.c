...
bool custom_msg_interfaces__msg__detection_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msg_interfaces.msg._detection_result.DetectionResult", full_classname_dest, 59) == 0);
  }
  custom_msg_interfaces__msg__DetectionResult * ros_message = _ros_message;
  {  // header
...
PyObject * custom_msg_interfaces__msg__detection_result__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msg_interfaces.msg._detection_result");
