...
class Metaclass_Interpolation_Event(type):
    """Metaclass of message 'Interpolation_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__interpolation__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__interpolation__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__interpolation__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__interpolation__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__interpolation__event
...
class Interpolation_Event(metaclass=Metaclass_Interpolation_Event):
    """Message class 'Interpolation_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<custom_msg_interfaces/Interpolation_Request, 1>',
        'response': 'sequence<custom_msg_interfaces/Interpolation_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['custom_msg_interfaces', 'srv'], 'Interpolation_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['custom_msg_interfaces', 'srv'], 'Interpolation_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from custom_msg_interfaces.srv import Interpolation_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, Interpolation_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'Interpolation_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from custom_msg_interfaces.srv import Interpolation_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Interpolation_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'Interpolation_Response'"
...
class Metaclass_Interpolation(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_msg_interfaces.srv.Interpolation')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from custom_msg_interfaces.srv import _interpolation
            ...
            if _interpolation.Metaclass_Interpolation_Event._TYPE_SUPPORT is None:
                _interpolation.Metaclass_Interpolation_Event.__import_type_support__()


class Interpolation(metaclass=Metaclass_Interpolation):
    from custom_msg_interfaces.srv._interpolation import Interpolation_Request as Request
    from custom_msg_interfaces.srv._interpolation import Interpolation_Response as Response
    from custom_msg_interfaces.srv._interpolation import Interpolation_Event as Event
