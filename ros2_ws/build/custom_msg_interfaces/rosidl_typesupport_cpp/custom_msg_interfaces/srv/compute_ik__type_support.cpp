...
static const _ComputeIK_Request_type_support_symbol_names_t _ComputeIK_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg_interfaces, srv, ComputeIK_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msg_interfaces, srv, ComputeIK_Request)),
  }
};
...
{
  return &::custom_msg_interfaces::srv::rosidl_typesupport_cpp::ComputeIK_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_msg_interfaces, srv, ComputeIK_Request)() {
  return get_message_type_support_handle<custom_msg_interfaces::srv::ComputeIK_Request>();
}
...
static const _ComputeIK_Response_type_support_symbol_names_t _ComputeIK_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg_interfaces, srv, ComputeIK_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msg_interfaces, srv, ComputeIK_Response)),
  }
};
...
{
  return &::custom_msg_interfaces::srv::rosidl_typesupport_cpp::ComputeIK_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_msg_interfaces, srv, ComputeIK_Response)() {
  return get_message_type_support_handle<custom_msg_interfaces::srv::ComputeIK_Response>();
}
...
typedef struct _ComputeIK_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _ComputeIK_Event_type_support_ids_t;

static const _ComputeIK_Event_type_support_ids_t _ComputeIK_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _ComputeIK_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _ComputeIK_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _ComputeIK_Event_type_support_symbol_names_t _ComputeIK_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg_interfaces, srv, ComputeIK_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msg_interfaces, srv, ComputeIK_Event)),
  }
};

typedef struct _ComputeIK_Event_type_support_data_t
{
  void * data[2];
} _ComputeIK_Event_type_support_data_t;

static _ComputeIK_Event_type_support_data_t _ComputeIK_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _ComputeIK_Event_message_typesupport_map = {
  2,
  "custom_msg_interfaces",
  &_ComputeIK_Event_message_typesupport_ids.typesupport_identifier[0],
  &_ComputeIK_Event_message_typesupport_symbol_names.symbol_name[0],
  &_ComputeIK_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t ComputeIK_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_ComputeIK_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::custom_msg_interfaces::srv::rosidl_typesupport_cpp::ComputeIK_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_msg_interfaces, srv, ComputeIK_Event)() {
  return get_message_type_support_handle<custom_msg_interfaces::srv::ComputeIK_Event>();
}
...
static const _ComputeIK_type_support_symbol_names_t _ComputeIK_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg_interfaces, srv, ComputeIK)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msg_interfaces, srv, ComputeIK)),
  }
};
...
static const rosidl_service_type_support_t ComputeIK_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<custom_msg_interfaces::srv::ComputeIK_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<custom_msg_interfaces::srv::ComputeIK_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<custom_msg_interfaces::srv::ComputeIK_Event>(),
...
{
  return &::custom_msg_interfaces::srv::rosidl_typesupport_cpp::ComputeIK_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_msg_interfaces, srv, ComputeIK)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<custom_msg_interfaces::srv::ComputeIK>();
}
