...
#include "custom_msg_interfaces/msg/detail/detection_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msg_interfaces::msg::DetectionResult & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msg_interfaces::msg::DetectionResult & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msg_interfaces::msg::DetectionResult;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msg_interfaces
max_serialized_size_key_DetectionResult(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const custom_msg_interfaces::msg::DetectionResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msg_interfaces::msg::DetectionResult *>(
    untyped_ros_message);
...
{
  return &custom_msg_interfaces::msg::typesupport_fastrtps_cpp::_DetectionResult__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg_interfaces, msg, DetectionResult)() {
  return &custom_msg_interfaces::msg::typesupport_fastrtps_cpp::_DetectionResult__handle;
}
