...
# TODO:
- ~need to transform coordinates from camera's frame to base's frame~ done in position, need to check if it works
- create x and y destination locations for each block (z is the same as the initial one)
