...
#include "custom_msg_interfaces/srv/detail/compute_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msg_interfaces::srv::ComputeTrajectory_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msg_interfaces::srv::ComputeTrajectory_Request & ros_message)
{
  // Member: array
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msg_interfaces::srv::ComputeTrajectory_Request;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msg_interfaces
max_serialized_size_key_ComputeTrajectory_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const custom_msg_interfaces::srv::ComputeTrajectory_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msg_interfaces::srv::ComputeTrajectory_Request *>(
    untyped_ros_message);
...
{
  return &custom_msg_interfaces::srv::typesupport_fastrtps_cpp::_ComputeTrajectory_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg_interfaces, srv, ComputeTrajectory_Request)() {
  return &custom_msg_interfaces::srv::typesupport_fastrtps_cpp::_ComputeTrajectory_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msg_interfaces
cdr_serialize(
  const custom_msg_interfaces::srv::ComputeTrajectory_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: trajectory
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msg_interfaces::srv::ComputeTrajectory_Response & ros_message)
{
  // Member: trajectory
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_msg_interfaces::srv::ComputeTrajectory_Response;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msg_interfaces
max_serialized_size_key_ComputeTrajectory_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const custom_msg_interfaces::srv::ComputeTrajectory_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_msg_interfaces::srv::ComputeTrajectory_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_msg_interfaces::srv::typesupport_fastrtps_cpp::_ComputeTrajectory_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg_interfaces, srv, ComputeTrajectory_Response)() {
  return &custom_msg_interfaces::srv::typesupport_fastrtps_cpp::_ComputeTrajectory_Response__handle;
}
...
// functions for custom_msg_interfaces::srv::ComputeTrajectory_Request already declared above

// functions for custom_msg_interfaces::srv::ComputeTrajectory_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msg_interfaces
cdr_serialize(
  const custom_msg_interfaces::srv::ComputeTrajectory_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msg_interfaces::srv::ComputeTrajectory_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msg_interfaces
max_serialized_size_ComputeTrajectory_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_msg_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_ComputeTrajectory_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_msg_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_ComputeTrajectory_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_msg_interfaces::srv::ComputeTrajectory_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msg_interfaces
max_serialized_size_key_ComputeTrajectory_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_msg_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_ComputeTrajectory_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_msg_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_ComputeTrajectory_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const custom_msg_interfaces::srv::ComputeTrajectory_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_msg_interfaces::srv::ComputeTrajectory_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ComputeTrajectory_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const custom_msg_interfaces::srv::ComputeTrajectory_Event *>(
...
static size_t _ComputeTrajectory_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ComputeTrajectory_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ComputeTrajectory_Event__callbacks = {
  "custom_msg_interfaces::srv",
...
static rosidl_message_type_support_t _ComputeTrajectory_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ComputeTrajectory_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &custom_msg_interfaces::srv::typesupport_fastrtps_cpp::_ComputeTrajectory_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg_interfaces, srv, ComputeTrajectory_Event)() {
  return &custom_msg_interfaces::srv::typesupport_fastrtps_cpp::_ComputeTrajectory_Event__handle;
}
...
static const rosidl_service_type_support_t _ComputeTrajectory__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ComputeTrajectory__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<custom_msg_interfaces::srv::ComputeTrajectory_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<custom_msg_interfaces::srv::ComputeTrajectory_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<custom_msg_interfaces::srv::ComputeTrajectory_Event>(),
...
{
  return &custom_msg_interfaces::srv::typesupport_fastrtps_cpp::_ComputeTrajectory__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg_interfaces, srv, ComputeTrajectory)() {
  return &custom_msg_interfaces::srv::typesupport_fastrtps_cpp::_ComputeTrajectory__handle;
}
