...
#include "custom_msg_interfaces/srv/detail/compute_path__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msg_interfaces::srv::ComputePath_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msg_interfaces::srv::ComputePath_Request & ros_message)
{
  // Member: pose_start
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msg_interfaces::srv::ComputePath_Request;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msg_interfaces
max_serialized_size_key_ComputePath_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const custom_msg_interfaces::srv::ComputePath_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msg_interfaces::srv::ComputePath_Request *>(
    untyped_ros_message);
...
{
  return &custom_msg_interfaces::srv::typesupport_fastrtps_cpp::_ComputePath_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg_interfaces, srv, ComputePath_Request)() {
  return &custom_msg_interfaces::srv::typesupport_fastrtps_cpp::_ComputePath_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msg_interfaces
cdr_serialize(
  const custom_msg_interfaces::srv::ComputePath_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: poses
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msg_interfaces::srv::ComputePath_Response & ros_message)
{
  // Member: poses
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_msg_interfaces::srv::ComputePath_Response;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msg_interfaces
max_serialized_size_key_ComputePath_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const custom_msg_interfaces::srv::ComputePath_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_msg_interfaces::srv::ComputePath_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_msg_interfaces::srv::typesupport_fastrtps_cpp::_ComputePath_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg_interfaces, srv, ComputePath_Response)() {
  return &custom_msg_interfaces::srv::typesupport_fastrtps_cpp::_ComputePath_Response__handle;
}
...
// functions for custom_msg_interfaces::srv::ComputePath_Request already declared above

// functions for custom_msg_interfaces::srv::ComputePath_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msg_interfaces
cdr_serialize(
  const custom_msg_interfaces::srv::ComputePath_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msg_interfaces::srv::ComputePath_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msg_interfaces
max_serialized_size_ComputePath_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_msg_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_ComputePath_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_msg_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_ComputePath_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_msg_interfaces::srv::ComputePath_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msg_interfaces
max_serialized_size_key_ComputePath_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_msg_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_ComputePath_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_msg_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_ComputePath_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const custom_msg_interfaces::srv::ComputePath_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_msg_interfaces::srv::ComputePath_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ComputePath_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const custom_msg_interfaces::srv::ComputePath_Event *>(
...
static size_t _ComputePath_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ComputePath_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ComputePath_Event__callbacks = {
  "custom_msg_interfaces::srv",
  "ComputePath_Event",
...
static rosidl_message_type_support_t _ComputePath_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ComputePath_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &custom_msg_interfaces::srv::typesupport_fastrtps_cpp::_ComputePath_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg_interfaces, srv, ComputePath_Event)() {
  return &custom_msg_interfaces::srv::typesupport_fastrtps_cpp::_ComputePath_Event__handle;
}
...
static const rosidl_service_type_support_t _ComputePath__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ComputePath__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<custom_msg_interfaces::srv::ComputePath_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<custom_msg_interfaces::srv::ComputePath_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<custom_msg_interfaces::srv::ComputePath_Event>(),
...
{
  return &custom_msg_interfaces::srv::typesupport_fastrtps_cpp::_ComputePath__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg_interfaces, srv, ComputePath)() {
  return &custom_msg_interfaces::srv::typesupport_fastrtps_cpp::_ComputePath__handle;
}
